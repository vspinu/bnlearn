...
SEXP hc_cache_fill(SEXP nodes, SEXP data, SEXP network, SEXP score, SEXP extra,
    SEXP reference, SEXP equivalence, SEXP decomposability, SEXP updated,
    SEXP env, SEXP amat, SEXP cache, SEXP blmat, SEXP debug) {
...
SEXP arc, callenv, params, delta, op, dummy, temp;
  ...
  PROTECT(params = callenv = allocList(11));
